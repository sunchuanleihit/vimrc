...
* **The Basic**: If you want something small just copy [basic.vim](git@github.com:sunchuanleihit/vimrc.git) into your ~/.vimrc and you will have a good basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:
	...
	git clone git@github.com:sunchuanleihit/vimrc.git ~/.vim_runtime
